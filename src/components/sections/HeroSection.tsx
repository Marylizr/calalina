    ...
    >
      <div className="mx-auto grid min-h-[calc(100svh-76px)] max-w-7xl items-center gap-10 px-4 py-10 sm:px-6 sm:py-14 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
        <div className="relative z-10 min-w-0 text-center">
          <h1 className="mx-auto max-w-84 text-balance font-serif text-[2.75rem] font-black leading-[0.98] text-(--color-dark-ink) min-[390px]:max-w-92 min-[390px]:text-[3.15rem] sm:max-w-3xl sm:text-6xl sm:leading-[0.95] lg:text-7xl">
            {content.title}
          </h1>
          <p className="mx-auto mt-6 max-w-88 text-base font-bold leading-7 text-(--color-muted-text) min-[390px]:max-w-96 sm:mt-8 sm:max-w-2xl sm:text-xl sm:leading-8">
            {content.text}
          </p>
